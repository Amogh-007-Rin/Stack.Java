...
- [Module 00: Introduction to Java — History, Philosophy, and Applications](module-00-introduction-to-java/)
- [Module 01: Setting Up Your Environment (JDK, JAVA_HOME, javac/java, IDE options)](module-01-setting-up-your-environment/)
- [Module 02: Your First Java Program (Hello World, anatomy of a class and main)](module-02-your-first-java-program/)
- [Module 03: Java Syntax Basics, Comments, and Program Structure](module-03-java-syntax-basics-comments-and-program-structure/)

### Phase 2: Core Language Fundamentals (Modules 4–19)

- [Module 04: Variables and Primitive Data Types](module-04-variables-and-primitive-data-types/)
- [Module 05: Type Casting and Conversion](module-05-type-casting-and-conversion/)
- [Module 06: Operators (Arithmetic, Relational, Logical, Bitwise, Assignment)](module-06-operators/)
- [Module 07: Reading Input from the Console (Scanner)](module-07-reading-input-from-the-console/)
- [Module 08: Strings and String Methods](module-08-strings-and-string-methods/)
- [Module 09: StringBuilder and StringBuffer](module-09-stringbuilder-and-stringbuffer/)
